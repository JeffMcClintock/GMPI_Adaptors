...
//           VcvAdaptor.h reads to generate GMPI XML. These are small and
...
struct Port
{
	...
	// it actually drives — see VcvProcessor's constructor.
	//
...
// REAL, not just accepted-and-dropped: VcvAdaptor.h reads this back to
