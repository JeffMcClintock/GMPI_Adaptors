// VCVAdaptor — run a VCV Rack module inside a GMPI plugin, generically.
//
...
class VcvProcessor : public gmpi::Processor
{
public:
	explicit VcvProcessor(const char* slug)
	{
		...
		setSubProcess(&VcvProcessor::subProcess);
	}
