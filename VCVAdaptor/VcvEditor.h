// VcvEditor — the GUI counterpart of VcvProcessor.
//
// Draws a Rack module's panel SVG and makes its knobs work, generically. Like
// VcvProcessor it names no module type: the panel art comes in as a string,
...
//
//     namespace {
//     auto r = vcv::registerEditor("VCV: Fade",
//         [] { return vcv::createEditor("Fade", kFadePanelSvg); });
//     }
//
